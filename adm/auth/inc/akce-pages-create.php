...
$qry = "INSERT INTO clanky (`keywords`, `description`, `title`, `www`, `nazev`, `clanek`) values ('$o_key', '$o_desc', '$o_title', '$o_url', '$o_nazev', '$o_clanek')";
        $ret=mysql_query($qry);
/*
        $nove_id= mysql_insert_id();

$qry = "INSERT INTO menu_kat (`clanky`, `kategorie`) values (".$nove_id.",".$o_kategories.")";
        $ret=mysql_query($qry);
*/        
        if (!$qry)
