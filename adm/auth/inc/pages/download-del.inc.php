...
?>
              ...
              <div class="edit-list-wrap">
                  ...
                  <form class="edit-list-form" action="./inc/akce-delete-download.inc.php" method="post">
<?php
...
$vysledek=mysql_query("SELECT * FROM download WHERE id='$id'");
while ($zaznam=MySQL_Fetch_Array($vysledek)): 
                                echo "<fieldset class=\"edit-form-left\">
                                      ...
                                      <input class=\"text\" type=\"text\" value='".$zaznam['name']."' id=\"page-title\" name=\"page-title\" title=\"Název souboru\"/>
                                  </fieldset>";
  endwhile; ?>
